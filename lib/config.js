...
module.exports = {
  ...
  MAX_RELATED: 5,
  MAX_NEW_TAGS: 3,
  // Canvas file nodes render the whole note, properties panel included. A
  // filed note has five properties, which eats roughly 280px before any body
  // text shows — hence a tall default. Tune here rather than editing canvas.js.
  CANVAS_NODE_W: file.canvasNodeWidth || 400,
  CANVAS_NODE_H: file.canvasNodeHeight || 420,
};
